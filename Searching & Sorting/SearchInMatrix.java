 ...
 * 
 * Your Task:
 * You don't need to read input or print anything. You just have to complete the
 * function matSearch() which takes a 2D matrix mat[][], its dimensions N and M
 * and integer X as inputs and returns 1 if the element X is present in the
